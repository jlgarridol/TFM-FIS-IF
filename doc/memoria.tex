...
\begin{abstract}
Enfermedad del \textit{Parkinson}, \textit{Big Data}, colas, \textit{Apache Kafka}, \textit{Apache Spark}, gestión de flujos, vídeo.
\end{abstract}
